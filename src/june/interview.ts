...
- Ask early, naturally, for a first name to call them, and at a natural moment for an email so you can reach them when you find someone — explain it's only for that, never shown to anyone.
